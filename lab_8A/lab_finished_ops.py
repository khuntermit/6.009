    ...
    if isinstance(tree, list):
        ...
        if op == 'if':
            ...
            if comb in carlae_builtins:
                bool = evaluate(tree[1])
                if bool == '#t':
                    return evaluate(tree[2])
                elif bool == '#f':
                    return evaluate(tree[3])
            if comb == 'and':
                # if the first something then the second has to be the same
                pass
            elif comb == 'or':
                # continue until something is true
                pass
            else:
                # evaluate tree[1] and return appropriate true/false expression
                pass
